            ...
            >
                ...
                >
                     <div className="heading mt-10 text-center ltr:lg:text-left rtl:lg:text-right">
                                                   <h6 className="!text-secondary">Admin-Announcements, Clubs & Societies, Gallery</h6>
                                                   <p className="text-black font-bold text-4xl">RUMAH KESATRIA JUARA ROAD RUN 2025</p>
                ...
                >
                    <img
                        src="/assets/images/RUMAHKASATRIA.jpeg"
                        alt="Pengetua"
