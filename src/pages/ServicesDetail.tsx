...
const Servicesdetail = () => {
    document.title = 'Services Detail | Plurk – Tailwind CSS Multipurpose Landing Templates';
                    ...
                    <div className="relative z-10 lg:flex">
                        ...
                        <form action="" className="rounded-3xl bg-white px-4 py-12 dark:bg-[#101626] lg:w-2/3 lg:px-8">
                            ...
                            <div className="mt-10 text-center ltr:lg:text-right rtl:lg:text-left">
                                <button type="button" className="btn bg-gray px-12 capitalize text-white dark:bg-primary dark:text-black dark:hover:bg-secondary">
                                    Send Message
                                </button>
                            </div>
                        </form>
