...
const Feedback = ({
    ...
    feedbacks = [
        {
            ...
            role: 'Malaysia',
            message:
                'I have always been skeptical about the integrity of voting systems, but since using the blockchain voting application, my doubts have vanished. The transparency and immutability provided by blockchain technology ensure that my vote is accurately recorded and cannot be tampered with. ',
        },
        {
            id: 2,
            name: 'Frencis',
            role: 'Indonesia',
            message:
                "The blockchain voting application has eliminated any concerns I had about voter fraud. The decentralized nature of blockchain ensures that there is no central authority with the power to manipulate or influence the results. It's a game-changer for democracy, restoring trust in the electoral process.",
        },
        {
            id: 3,
            name: 'Janise',
            role: 'Thailand',
            message:
                "I've always wanted my vote to truly matter, and the blockchain voting application has made that a reality. The ability to verify and track my vote through the blockchain gives me confidence that my voice counts. ",
        },
    ],
    className = '',
}) => {
    ...
    return (
        <section className={`relative bg-transparent dark:bg-transparent mt-10 md:mt-20 ${className}`}>
            ...
            <div className="container">
                <div
                    className={`heading mb-10 text-center text-3xl font-extrabold text-cyan lg:mb-14 ltr:lg:text-center rtl:lg:text-center ${
                        showTitle ? '' : 'hidden'
                    }`}
                >
                    <h6>Feedbacks</h6>
                    <h4>What Others are Saying About Blockchain Voting</h4>
                </div>
                                            ...
                                            <div className="grid grid-cols-1 items-center gap-4">
                                                <div className="col-span-1">
                                                    <div className="relative rounded-3xl bg-white/[0.02] p-6">
                                                        ...
                                                        <p className="relative min-h-[150px] break-words font-medium italic text-white">
                                                            {feedback.message}
