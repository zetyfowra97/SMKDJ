...
const Header = (props: any) => {
    ...
    return (
        <header className={`fixed top-0 z-50 bg-black/0 transition duration-300 ${props.className} w-screen`}>
            <div className="container">
                <div className="flex items-center justify-between py-5 lg:py-0">
                    <Link to="/">
                        <img src="/assets/images/fpgsc-logo-2.png" alt="logo" className="lg:h-[80px] h-[50px] " />
                    </Link>
                    <div className="flex items-center">
                        ...
                        <button
                            type="button"
                            className="flex h-10 w-10 items-center justify-center rounded-full bg-yellow-50 lg:hidden"
                            onClick={() => toggleMenu()}
                        >
